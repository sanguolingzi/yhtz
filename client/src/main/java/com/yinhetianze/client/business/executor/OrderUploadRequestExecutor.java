...
@Service
public class OrderUploadRequestExecutor extends AbstractClientExecutorPostAdapter
{
    @Override
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.order.spring.application.name", "customer-server");
    }

    @Override
    protected String getServerContext()
    {
        return applicationPropertiesUtil.getStrProp("server.order.server.context-path", "/customer");
    }
