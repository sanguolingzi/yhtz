...
@Service
public class SysUploadRequestExecutor extends AbstractClientExecutorPostAdapter
{
    @Override
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.sys.spring.application.name", "customer-server");
    }

    @Override
    protected String getServerContext()
    {
        return applicationPropertiesUtil.getStrProp("server.sys.server.context-path", "/customer");
    }
