...
@Service
public class ProductPostRequestExecutor extends AbstractClientExecutorPostAdapter
{
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.product.spring.application.name");
    }
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.product.server.context-path");
    }
}
