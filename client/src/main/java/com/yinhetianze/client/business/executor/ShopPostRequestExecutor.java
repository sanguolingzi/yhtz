...
@Service
public class ShopPostRequestExecutor extends AbstractClientExecutorPostAdapter
{
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.shop.spring.application.name");
    }
