...
@Service
public class BillingPostRequestExecutor extends AbstractClientExecutorPostAdapter
{
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.billing.spring.application.name");
    }
