...
@Service
public class TaskPostRequestExecutor extends AbstractClientExecutorPostAdapter
{
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.task.spring.application.name");
    }
