...
@Service
public class CustomerUploadRequestExecutor extends AbstractClientExecutorPostAdapter
{
    @Override
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.customer.spring.application.name", "customer-server");
    }

    @Override
    protected String getServerContext()
    {
        return applicationPropertiesUtil.getStrProp("server.customer.server.context-path", "/customer");
    }
