...
@Service
public class SysGetRequestExecutor extends AbstractClientExecutorGetAdapter
{
    ...
    {
        String serverName = applicationPropertiesUtil.getStrProp("server.sys.spring.application.name");
        return serverName;
    }
    ...
    {
        // 记录日志
        LoggerUtil.warn(SysGetRequestExecutor.class, "[{}] responses failed！failed message ：requestURI={}，params={}",
