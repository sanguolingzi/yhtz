...
@Service
public class ShopUploadRequestExecutor extends AbstractClientExecutorPostAdapter
{
    @Override
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.shop.spring.application.name", "shop-server");
    }

    @Override
    protected String getServerContext()
    {
        return applicationPropertiesUtil.getStrProp("server.shop.server.context-path", "/shop");
    }
