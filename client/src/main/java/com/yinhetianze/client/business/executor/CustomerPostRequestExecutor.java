...
@Service
public class CustomerPostRequestExecutor extends AbstractClientExecutorPostAdapter
{
    ...
    {
        return applicationPropertiesUtil.getStrProp("server.customer.spring.application.name");
    }
