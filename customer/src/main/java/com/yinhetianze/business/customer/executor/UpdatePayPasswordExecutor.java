...
@Component
public class UpdatePayPasswordExecutor extends AbstractRestBusiExecutor<String> {
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        busiCustomerPojo.setPayPassword(CustomerUtil.createPassword(busiUpdatePasswordModel.getNewPassword()));
    ...
    protected ErrorMessage validate(HttpServletRequest request, BasicModel model, Object[] params) {
        ...
        ////查询该用户是否有支付密码  若有 则默认为修改密码 进行修改密码得逻辑校验 否则 认为是设置新密码
        if(CommonUtil.isNotEmpty(busiCustomerPojo.getPayPassword())){
            if(CommonUtil.isEmpty(busiUpdatePasswordModel.getPayPassword())){
             ...
             * 输入原密码是否与数据库密码相同
             */
            if(!CustomerUtil.checkPassword(busiCustomerPojo.getPayPassword(),busiUpdatePasswordModel.getPayPassword())){
             ...
             * 校验新密码是否与原密码相同
             */
            if(busiUpdatePasswordModel.getPayPassword().equalsIgnoreCase(busiUpdatePasswordModel.getNewPassword())){
