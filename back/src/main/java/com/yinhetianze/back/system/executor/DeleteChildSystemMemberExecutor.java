...
@Service
public class DeleteChildSystemMemberExecutor extends AbstractRestBusiExecutor<String> {
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result = sysMemberBusiServiceImpl.deleteChildSysMember(deleteModel.getIds());
        if(result <= 0){
