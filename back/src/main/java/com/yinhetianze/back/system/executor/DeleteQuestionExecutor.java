...
@Service
public class DeleteQuestionExecutor extends AbstractRestBusiExecutor<String> {
    @Autowired
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result=questionBusiServiceImpl.deleteQuestion(questionPojo);
        if(result!=1){
            throw new BusinessException("删除问答失败");
        }
        return "success";
    }
