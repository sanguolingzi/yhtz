 ...
 */
@Component
public class AddSysMenuExecutor extends AbstractRestBusiExecutor<String> {
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result = sysMenuBusiServiceImpl.insertSelective(sysMenuPojo);
        if(result <= 0)
   ...
   @Override
    protected ErrorMessage validate(HttpServletRequest request, BasicModel model, Object[] params) {
        ...
        if(CommonUtil.isEmpty(sysMenuModel.getMenuName())){
            errorMessage.rejectNull("menuName",null,"菜单名称");
            return errorMessage;
        }
