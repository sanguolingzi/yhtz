 ...
 */
@Component
public class UpdateSysRoleExecutor extends AbstractRestBusiExecutor<String> {
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result = sysRoleBusiServiceImpl.updateInfo(busiSysRoleModel);
        if(result <= 0)
    ...
    protected ErrorMessage validate(HttpServletRequest request, BasicModel model, Object[] params) {
        ...
        if(busiSysRolePojo != null
                && busiSysRolePojo.getId().intValue() != busiSysRoleModel.getId().intValue()){
