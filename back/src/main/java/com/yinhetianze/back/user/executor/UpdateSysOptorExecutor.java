 ...
 */
@Component
public class UpdateSysOptorExecutor extends AbstractRestBusiExecutor<String> {
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result = sysOptorBusiServiceImpl.updateInfo(busiSysOptorModel);
        if(result <= 0)
    ...
    protected ErrorMessage validate(HttpServletRequest request, BasicModel model, Object[] params) {
        ...
        if(busiSysOptorPojo != null
                && busiSysOptorPojo.getId().intValue() != busiSysOptorModel.getId().intValue() ){
