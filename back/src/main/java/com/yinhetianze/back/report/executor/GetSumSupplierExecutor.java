...
@Component
public class GetSumSupplierExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        Integer sumSupplier=reportInfoServiceImpl.selectSumSupplier();
        Map map=new HashMap();
        map.put("sumSupplier",sumSupplier);
        return map;
    }
}
