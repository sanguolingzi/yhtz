...
@Component
public class DeleteSysSyspropertiesExecutor extends AbstractRestBusiExecutor<Object> {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result = sysSyspropertiesServiceImpl.deleteInfo(deleteModel.getIds());
        if(result <= 0)
