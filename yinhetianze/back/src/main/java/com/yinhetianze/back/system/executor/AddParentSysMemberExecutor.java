...
@Service
public class AddParentSysMemberExecutor extends AbstractRestBusiExecutor<String> {
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        int result = sysMemberBusiServiceImpl.addParentSysMember(sysMemberInfoModel);
        if(result <= 0){
    ...
    protected ErrorMessage validate(HttpServletRequest request, BasicModel model, Object[] params) {
        ...
        if(CommonUtil.isEmpty(sysMemberInfoModel.getMemberTitle())){
            errorMessage.rejectNull("memberTitle",null,"权益标题");
        }
