...
@Component
public class DeleteConcatenatedCodeExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        concatenatedCodePojo.setId(concatenatedCodeModel.getId());
        concatenatedCodePojo.setDelFlag((short)1);
