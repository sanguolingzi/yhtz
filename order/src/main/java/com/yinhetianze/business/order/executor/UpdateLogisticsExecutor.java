...
@Service
public class UpdateLogisticsExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        map.put("userId",tokenUser.getId());
        int i = orderBusiServiceImpl.updateLogistics(map);
        if (i != 1) {
            throw new BusinessException("订单添加物流失败");
        }
        return "success";
    }
