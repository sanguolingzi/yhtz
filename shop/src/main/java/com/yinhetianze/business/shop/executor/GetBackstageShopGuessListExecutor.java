...
@Component
public class GetBackstageShopGuessListExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        PageInfo pageInfo=new PageInfo(shopGuessInfoServiceImpl.selectBackstageShopGuessList());
