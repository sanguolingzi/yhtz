...
@Component
public class GetOneAreaListExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        if(CommonUtil.isNotEmpty(oneAreaModel.getProdName())){
            try {
                ...
                LoggerUtil.error(GetOneAreaListExecutor.class, e);
            }
        }
        PageHelper.startPage(oneAreaModel.getCurrentPage(), oneAreaModel.getPageSize());
        PageInfo pageInfo=new PageInfo(oneAreaInfoServiceImpl.selectOneAreaList(oneAreaPojo));
