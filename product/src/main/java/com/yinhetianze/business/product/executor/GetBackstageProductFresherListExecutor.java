...
@Component
public class GetBackstageProductFresherListExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        if(CommonUtil.isNotEmpty(productFresherModel.getProdName())){
            try {
                ...
                LoggerUtil.error(GetBackstageProductFresherListExecutor.class, e);
            }
        }
        PageHelper.startPage(productFresherModel.getCurrentPage(), productFresherModel.getPageSize());
        PageInfo pageInfo=new PageInfo(productFresherInfoServiceImpl.selectBackstageProductFresherList(productFresherPojo));
