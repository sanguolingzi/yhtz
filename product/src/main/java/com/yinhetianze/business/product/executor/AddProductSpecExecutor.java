 ...
 */
@Service
public class AddProductSpecExecutor extends AbstractRestBusiExecutor<String>{
    @Autowired
    ...
    protected String executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException{
        ...
        try {
            int result = productDetailBusiServiceImpl.addShopProductDetail(detailPojoList, prodPojo);
            if (result <= 0) {
                ...
                //成功返回skuCode码
                LoggerUtil.info(AddProductSpecExecutor.class, "添加单品信息成功：{}条记录", new Object[]{result});
                return detailPojoList.get(0).getSkuCode();
            }
        } catch (Exception e) {
            LoggerUtil.error(AddProductSpecExecutor.class, e);
