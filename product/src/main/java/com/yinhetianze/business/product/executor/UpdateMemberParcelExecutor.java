...
@Component
public class UpdateMemberParcelExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        MemberParcelPojo dbPojo=new MemberParcelPojo();
        dbPojo.setId(memberParcelModel.getId());
        dbPojo.setDelFlag((short)0);
        dbPojo=memberParcelInfoServiceImpl.selectOne(dbPojo);
        try {
            if(CommonUtil.isNotEmpty(memberParcelPojo.getParcelImg()) && !dbPojo.getParcelImg().equals(memberParcelPojo.getParcelImg())){
                ...
                LoggerUtil.info(UpdateMemberParcelExecutor.class, "MemberParcel update read local file "+storeFilePath+ File.separatorChar+memberParcelModel.getParcelImg());
                //读取本地文件
            ...
            LoggerUtil.error(UpdateMemberParcelExecutor.class,e.getMessage());
        }
