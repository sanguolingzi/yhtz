...
@Component
public class AddProductFresherExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        try {
            ...
            LoggerUtil.info(UpdateOneAreaExecutor.class, "ProductFresher add read local file "+storeFilePath+ File.separatorChar+productFresherModel.getProdImg());
            //读取本地文件
        ...
        int result=productFresherBusiServiceImpl.addProductFresher(productFresherPojo);
        if(result<=0)
    ...
    protected ErrorMessage validate(HttpServletRequest request, BasicModel model, Object[] params) {
        ...
        if(CommonUtil.isEmpty(productFresherModel.getuPrice())){
            errorMessage.rejectNull("uPrice","null","U币抵扣量");
        }
        /*
