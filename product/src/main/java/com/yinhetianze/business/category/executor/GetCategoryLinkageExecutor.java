 ...
 */
@Service
public class GetCategoryLinkageExecutor  extends AbstractRestBusiExecutor<List<Map<String,Object>>>

{
    ...
    {
        //查询所有分类
        List<Map<String,Object>> list = categoryInfoServiceImpl.getSelectMap();
        //一级分类
