...
@Component
public class GetBackstageActivityProductListExecutor extends AbstractRestBusiExecutor {
    ...
    protected Object executeBusiness(HttpServletRequest request, HttpServletResponse response, BasicModel model, Object... params) throws BusinessException {
        ...
        if(CommonUtil.isNotEmpty(activityProductModel.getProdName())){
            try {
                String prodName = URLDecoder.decode(activityProductModel.getProdName(), "UTF-8");
                activityProductPojo.setProdName(prodName);
            }catch (Exception e){
        ...
        PageInfo pageInfo=new PageInfo(activityProductInfoServiceImpl.selectBackstageActivityProductList(activityProductPojo));
